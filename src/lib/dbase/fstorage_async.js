...
async function async_fstorage_upload({ layer, path, imageQuality }) {
...
window.async_fstorage_upload = async_fstorage_upload;
...
async function async_fstorage_remove({ path }) {
  if (!path) {
...
window.async_fstorage_remove = async_fstorage_remove;

async function async_fstorage_download_url({ path }) {
...
window.async_fstorage_download_url = async_fstorage_download_url;
