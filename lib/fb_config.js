...
function init(config) {
  ...
  window.fb_.app = initializeApp(config);
  window.fb_.auth = getAuth();
  window.fb_.fbase.init();
  window.fb_.fstore.init();
}

import { fstore } from './fb_fstore.js';

import { fbase } from './fb_fbase.js';
